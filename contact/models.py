...
class ContactPage(AbstractEmailForm):
    """ 
    A form page that sends email. Pages implementing a form to be sent to an email should it be inherited
    """    
    ...
    map_image = models.ForeignKey(
        ...
        help_text = "Image will be cropped to 580x355px",
        related_name="+",)
    map_url =models.URLField(
        blank=True,
        help_text="The image will become a link once provided",
    )
